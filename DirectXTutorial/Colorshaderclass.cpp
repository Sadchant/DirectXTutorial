...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../DirectXTutorial/VertexShader.hlsl", L"../DirectXTutorial/PixelShader.hlsl");
	if (!result)
	{
		std::cout << "moep" << endl;
		return false;
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// dient vermutlich dazu, Daten in den Shader hineinzubekommen
